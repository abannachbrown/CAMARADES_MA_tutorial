...
## 1. Introduction to Meta-Analysis {#meta-analysis}
...
## 1.1.1 Effect sizes for infarct volume (NMD)
...
## 1.1.2 Random-effects meta-analysis
...
## 1.3.2 Meta-analysis & forest plot
...
## 1.4 Explore the IL1-RA neurobehavioural outcomes data set
...
In this data set, an NMD effect size (column ESi) and standard error (column SEi) have
already been calculated for each experiment. 

You can edit the code we used for the infarct volume data above and compare your results
to those in the paper (McCann et al 2016).
...
## 2. Detecting small study effects
...
In this exercise, we will use the complete infarct volume data set and meta-analysis from Part 1.1
...
We will test for funnel plat asymmetry with the "meta-bias" function. 


```{r quiz1_4_3, echo=FALSE}
...
## 2.4 Small study effects in neurobehavioural outcomes
...
Now use the analyses from Part 1.4 to test for funnel plot asymmetry and missing studies in the neurobehavioural data set, using the "funnel, "metabias", and "trimfill" functions above.
