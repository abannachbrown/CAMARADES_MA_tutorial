...
Have a look at the new R window that opened when you ran the code and check that the only studies remaining are those where the drug delivery mode is "Protein".
...
Have a look at the new R window that opened when you ran the code and check that the only studies remaining are those where the location of drug administration is "Central".
