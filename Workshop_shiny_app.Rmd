...
Next we will run a meta-analysis on this new data set, as performed in part 1.1:
...
quiz(caption = "Questions:",
  question("How is the forest plot different from the plot in Part 1.1?",
    answer("8", correct = TRUE),
    answer("14"),
    answer("1"),
    answer("23"),
